...
class MD_model():
    ...
    def execute_chain(self, max_degree=20, fun_max=5):
        ...
        print bool_list[-4]
        x_2 = feature_periodic(thread_periodic=bool_list[-4])
...
def get_CNT_distance(thread_node_list, df_xyz, type_choose = 22):
